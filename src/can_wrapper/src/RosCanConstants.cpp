...
const uint8_t RosCanConstants::VescIds::rear_left_vesc = 0x52;   /**< ID for the rear left VESC. */
const uint8_t RosCanConstants::VescIds::rear_right_vesc = 0x53;  /**< ID for the rear right VESC. */
...
const uint8_t RosCanConstants::VescIds::rear_left_stepper = 0x62;   /**< ID for the rear left stepper. */
const uint8_t RosCanConstants::VescIds::rear_right_stepper = 0x64;  /**< ID for the rear right stepper. */
