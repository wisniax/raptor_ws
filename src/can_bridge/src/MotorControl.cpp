...
void MotorControl::stopMotors()
{
	...
	rover_wheels_velocity_temp.front_left.turn.command_id = VESC_COMMAND_SET_CURRENT;
	rover_wheels_velocity_temp.front_right.turn.command_id = VESC_COMMAND_SET_CURRENT;
	rover_wheels_velocity_temp.rear_right.turn.command_id = VESC_COMMAND_SET_CURRENT;
	rover_wheels_velocity_temp.rear_left.turn.command_id = VESC_COMMAND_SET_CURRENT;
